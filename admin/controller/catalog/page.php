...
class ControllerCatalogPage extends Controller {
	...
	public function index() {
        ...
        $this->db->query('ALTER TABLE  `om_page` CHANGE  `url`  `url` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL ;');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') ) {
			...
			$this->response->redirect($this->url->link('catalog/page', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	public function repair() {
		...
		if ($this->validateRepair()) {
			$this->model_catalog_page->repairPages();
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/page', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/page/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/page/delete', 'token=' . $this->session->data['token'] . $url, true);
		$data['repair'] = $this->url->link('catalog/page/repair', 'token=' . $this->session->data['token'] . $url, true);
		...
		$data['pages'] = $this->model_catalog_page->getPages(0);

		$page_total = count($data['pages']);
		...
		$data['sort_name'] = $this->url->link('catalog/page', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/page', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/page', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (!isset($this->request->get['page_id'])) {
			$data['action'] = $this->url->link('catalog/page/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/page/edit', 'token=' . $this->session->data['token'] . '&page_id=' . $this->request->get['page_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/page', 'token=' . $this->session->data['token'] . $url, true);
