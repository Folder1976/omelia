              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($page['page_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                    <?php if ($page['url']) { ?>
                    <td class="left"><a href="/<?php echo $page['url']; ?>"><?php echo $page['name']; ?></a>&nbsp;&nbsp;<i class="fa fa-sort-desc"></i></td>
                  <?php } else { ?>
                    <td class="left"><?php echo $page['indent']; ?><?php echo $page['name']; ?></td>
                  <?php } ?>
                  <td class="text-right"><?php echo $page['sort_order']; ?></td>
                  <td class="text-right"><a href="/admin/index.php?route=catalog/page/edit&token=<?php echo $_GET['token']; ?>&page_id=<?php echo $page['page_id']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
