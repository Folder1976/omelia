...
<main class="site-content">
      ...
      <div class="block__wrap">
        <div class="block">
          <div class="block__text">
            <div class="block__title">життя в тренді</div>
            <div class="block__desc">Повсякденний одяг та аксесуари для молодих людей у стилі вуличної моди за доступними цінами</div>
          </div>
        ...
        <div class="block">
          <div class="block__text">
            <div class="block__title">Стиль та комфорт</div>
            <div class="block__desc">Високоякісна зручний одяг, що складається з дуже м'яких матеріалів, випадкових стилів та різнобарвних кольорів</div>
          </div>
        ...
        <div class="block">
          <div class="block__text">
            <div class="block__title">елегантність всюди</div>
            <div class="block__desc">Яскраві образи, якісний одяг і стильні новинки європейського бренду з доставкою по всій Україні</div>
          </div>
  ...
  <section class="section-novelties">
    <div class="container">
      <h2>новинки</h2>
      <ul class="tabs">
        <li><a href="#novelties-pb">P&B</a></li>
  ...
  <section class="section-look-book">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2>Look book</h2>
          <p>Образи від стилістів для жінок і чоловіків.<br>Джерело натхнення для власних стильних образів!</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
  ...
  <section class="section-text">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p><b>О.Meliya</b> — це мережа магазинів високоякісного, зручного, стильного одягу для жінок, чоловіків та дітей в Україні та закордоном.<br>Ми пропонуємо комфортний дизайнерський одяг як для повсякденного образу, так і для святкового. У нас виключно високоякісні матеріали європейського зразка.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="advantages">
            <div class="item">
              <div class="title">асортимент</div>
              <p>До вашої уваги широкий асортимент продукції нашого магазину. Товар завжди внаявності та багатий на новинки</p>
            </div>

            <div class="item">
              <div class="title">ексклюзив</div>
              <p>Над колекціями, що ми представляємо, працює більше 10-ти дизайнерів. Ми пильно слідкуємо за найновішими тенденціями в моді</p>
            </div>

            <div class="item">
              <div class="title">гарантія</div>
              <p>Обирайте нові образи та не переживайте ніпрощо. Ми впевнені в якості нашої продукції, тому гарантуємо її вам!</p>
            </div>
          </div>
